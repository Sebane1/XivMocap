...
{
    public unsafe class MediaBoneObject
    {
        private Bone _bone;
        ...
        Vector3 Rotation
        {
            get
            {
                try
                {
                    if (_bone != null)
                    {
                        return QuaternionToEuler(_bone.Transform.Rotation);
                    }
                    else
                    {
                        return Vector3.Zero;
        ...
        public static Vector3 QuaternionToEuler(hkQuaternionf q) // Returns the XYZ in ZXY
        {
            Vector3 angles;
